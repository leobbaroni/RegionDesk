...
The portable archive is `release/RegionDesk-0.1.2-Windows.zip`; extract all files and run `RegionDesk.exe`. It is unsigned and uses the default Electron icon.
